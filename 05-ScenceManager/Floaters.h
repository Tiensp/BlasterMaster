...
#define FLOATER_ANI_WALKING_LEFT_UP	0
#define FLOATER_ANI_WALKING_LEFT_DOWN 1
#define FLOATER_ANI_WALKING_RIGHT_UP 2
#define FLOATER_ANI_WALKING_RIGHT_DOWN 3
