...
BulletEyeball::BulletEyeball(float _start_x, float _start_y, LPGAMEOBJECT player)
{
...
void BulletEyeball::GetBoundingBox(float& left, float& top, float& right, float& bottom)
{
	if (!isDone)
	{
		left = x;
...
void BulletEyeball::SetState(int state)
{
