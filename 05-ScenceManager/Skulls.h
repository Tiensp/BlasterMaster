...
#define SKULL_ANI_COLLISION_RIGHT_UP 4
#define SKULL_ANI_COLLISION_LEFT_UP 5
#define SKULL_ANI_COLLISION_RIGHT 6
#define SKULL_ANI_COLLISION_LEFT 7

#define SKULL_WALKING_SPEED 0.05f;
#define	SKULL_JUMPING_SPEED 0.035f;
